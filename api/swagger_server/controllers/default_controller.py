...
from pharmacies import pharmacies_programm_reader as pr
...
def pharmacies_manager_pharmacie_id_set_unvailable_products_post(body, pharmacie_id):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        body = body.to_dict()
        products_ids  = body["products_ids"]
        r  = tasks.disable_products(M, pharmacie_id, products_ids)
    return result_model("", r)
...
def pharmacies_mananger_pharmacie_id_set_available_products_post(body, pharmacie_id):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        body = body.to_dict()
        products_ids  = body["products_ids"]
        r  = tasks.enable_products(M, pharmacie_id, products_ids)
    return result_model("", r)
...
def pharmacies_proximities_list_get(lat, long):  # noqa: E501
    ...
    :rtype: object
    """
    today_group =  pr.get_today_pharm_programm(r'../pharmacies/pharmacies_programm.json')
    r = tasks.search_pharmacies(M, lat, long, product_id=None, groupe=today_group, assurance=None)
    return result_model("", r)
...
def pharmacies_proximities_search_product_id_post(body, search_product_id):  # noqa: E501
    ...
    if connexion.request.is_json:
        ...
        if assurance == []:
            assurance = None
        r = tasks.search_pharmacies(M, lat, long, product_id=search_product_id, groupe=today_group, assurance=assurance)
    return result_model("", r)
